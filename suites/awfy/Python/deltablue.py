...
# NOTE: micropython doesn't have the `abc` module. Instead of using
# `abstractmethod`, I'll just make the implementations throw.
# from abc import abstractmethod

# NOTE: micropython doesn't support `enum`. It's OK here, as it's not really
# used anyway.
